    ...
    def assistant_output(self, prompt):
        ...
        for msg in messages.data:
            if msg.role == 'assistant':
                ...
                self.animate_text_output(name="Tintomax Assistente:", response=response_text)
...
def main(page: ft.Page):
    # Pagina ChatBot
    page.title = "Tintomax Assistentes"
    ...
    icons_path = resource_path("assets/icons/IconTMX.png")
    ...
    page.add(
        ...
        ft.Text("Tintomax Assistente", size=18, height=50, color="white", weight=ft.FontWeight.W_900),
        tit_row,
        main_content_area,
